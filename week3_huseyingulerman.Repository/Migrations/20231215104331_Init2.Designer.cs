...
namespace week3_huseyingulerman.Repository.Migrations
{
    ...
    [Migration("20231215104331_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("week3_huseyingulerman.Core.Entities.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("week3_huseyingulerman.Core.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("week3_huseyingulerman.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("week3_huseyingulerman.Core.Entities.Pet", b =>
                {
                    b.HasOne("week3_huseyingulerman.Core.Entities.AppUser", "AppUser")
                        .WithMany("Pets")
